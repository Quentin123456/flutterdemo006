...
import 'feedback_list_item_entity.dart';
// 2、这里手动输入：feedback_detail_list_entity.g.dart文件将在我们运行生成命令后自动生成
...
class FeedbackDetailListEntity {
  ...
  // 5、必须的方法
  FeedbackDetailListEntity(this.list);
  // 6、必须的代码：代码格式是固定的，将下面的“FeedbackDetailListEntity”关键词替换为你定义的model类名称即可
  // 反序列化
